package com.Scientific_Calculator.Scientific_Calculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void parantheseopentextBTNPush(View view){
        updateText(getResources().getString(R.string.parenthesesOpenText));
    }
    public void parantheseclosetextBTNPush(View view){
